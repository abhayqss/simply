...
module.exports = {
  SESSION_TOKEN_KEY:
    "hct74yfrt0cwy7n3rix74rbc4rts4cr7vshbn784yct4sc4sw4km0w8u4t9w4t54uw",
  ...
  demoUsers: [
    {
      ...
      username: "ntyler",
      password: "123",
      roleName: "ROLE_CARE_COORDINATOR", // Added for proper role-based UI
    ...
    },
    {
      ...
      username: "cpatnode",
      password: "111",
      roleName: "ROLE_ADMINISTRATOR", // Added for admin UI access
