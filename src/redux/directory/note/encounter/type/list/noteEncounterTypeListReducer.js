...
export default function noteEncounterTypeListReducer (state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case CLEAR_NOTE_ENCOUNTER_TYPE_LIST:
            return state
                .setIn(['dataSouce','data'], [])
                .removeIn(['error'])

        case LOAD_NOTE_ENCOUNTER_TYPE_LIST_SUCCESS: {
        ...
        case LOAD_NOTE_ENCOUNTER_TYPE_LIST_FAILURE:
            return state
