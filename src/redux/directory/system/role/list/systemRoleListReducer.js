...
export default function systemRoleListReducer (state = initialState, action) {
    ...
    switch (action.type) {
        ...
        case CLEAR_SYSTEM_ROLE_LIST:
            return state
                .setIn(['dataSource', 'data'], [])
                .removeIn(['error'])

        case LOAD_SYSTEM_ROLE_LIST_SUCCESS: {
        ...
        case LOAD_SYSTEM_ROLE_LIST_FAILURE:
            return state
